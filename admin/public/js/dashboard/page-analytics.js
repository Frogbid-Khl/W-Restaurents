    ...
    var dzChartlist = function () {
        ...
        var lineChart = function () {
            var optionsTimeline = {
                ...
                series: [{name: "New Clients", data: [180, 150, 200, 100, 80, 70, 40]}],
                plotOptions: {
                    bar: {
                        columnWidth: "25%",
                        endingShape: "rounded",
            ...
            if (jQuery('#widgetChart1').length > 0) {
                ...
                new Chart(chart_widget_1, {
                    ...
                    options: {
                        ...
                        elements: {point: {radius: 0, borderWidth: 0}},
                ...
                new Chart(doughnut_chart, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            backgroundColor: ["rgba(175, 54, 54, 1)", "rgba(60, 101, 245, 1)", "rgba(27, 211, 68, 1)", "rgba(255, 247, 66, 1)"],
                            hoverBackgroundColor: ["rgba(175, 54, 54, 0.5)", "rgba(60, 101, 245, 0.5)", "rgba(27, 211, 68, 0.5)", "rgba(255, 247, 66, 0.5)"]
                        }],
                    },
                    options: {weight: 1, cutoutPercentage: 60, responsive: true, maintainAspectRatio: false}
                });
            }
        }
        var lineChart2 = function () {
            var options = {
                ...
                }, {name: 'Expenses', data: [270, 650, 201, 90, 250, 750, 470, 550, 650, 270]}],
                ...
                xaxis: {
                    ...
                    labels: {style: {colors: '#fff', fontSize: '14px', fontFamily: 'Poppins', fontWeight: 100,},},
                },
                colors: ['#FFFFFF', '#22DBBA'],
                fill: {colors: ['#FFFFFF', '#22DBBA'], opacity: 1},
                tooltip: {
                    y: {
            ...
            if (jQuery('#lineChart_3').length > 0) {
                ...
                new Chart(lineChart_3, {
                    ...
                    options: {
                        ...
                        scales: {
                            yAxes: [{
                                ticks: {beginAtZero: true, max: 100, min: 0, stepSize: 20, padding: 10},
                                gridLines: {color: "rgba(255, 255, 255,0.05)", drawBorder: true}
                            }],
                            xAxes: [{
                                gridLines: {color: "rgba(255, 255, 255,0.05)", drawBorder: true},
                                ticks: {padding: 5}
                ...
                new Chart(pie_chart, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [45, 25, 20, 10],
                            borderWidth: 0,
                            backgroundColor: ["rgba(19, 180, 151, .9)", "rgba(19, 180, 151, .7)", "rgba(19, 180, 151, .5)", "rgba(0,0,0,0.07)"],
                            hoverBackgroundColor: ["rgba(19, 180, 151, .9)", "rgba(19, 180, 151, .7)", "rgba(19, 180, 151, .5)", "rgba(0,0,0,0.07)"]
                        }],
                        labels: ["one", "two", "three", "four"]
                    },
                    options: {responsive: true, legend: false, maintainAspectRatio: false}
                });
            }
        }
        return {
